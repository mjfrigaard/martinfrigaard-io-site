...
This post covers how to scrape a wikipedia table and store it in an R data frame. Below is an example setup code chunk. 
...
![Top of the table on wikipedia ](/post/2019-05-03-ww2-fighter-pilots-scraping-html-tables_files/head_pilots.png){width=60%}
...
![Bottom of the wikipedia table](/post/2019-05-03-ww2-fighter-pilots-scraping-html-tables_files/tail_pilots.png){width=60%}
