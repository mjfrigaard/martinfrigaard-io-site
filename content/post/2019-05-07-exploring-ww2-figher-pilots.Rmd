---
title: 'Part 2 - Exploring WW2 flying aces'
...
![inspectdf version 2](/post/2019-05-07-exploring-ww2-figher-pilots_files/inspect_na-again-1.png){width=100%}
...
![inspectdf_imb version 1](/post/2019-05-07-exploring-ww2-figher-pilots_files/inspect_imb-1.png){width=100%}
...
I use this function a lot for quickly viewing a data frame. 

## Who fought for which side?

I wanted a variable to categorize what side each country was on, Axis or Allied forces. These data are organized by the name of each pilot, but I can use the `country` column to create a variable that categorizes the data into two groups (or `force`s):
...
![Cleveland dot plot](/post/2019-05-07-exploring-ww2-figher-pilots_files/aerial-victories-by-force-country-1.png){width=100%}
